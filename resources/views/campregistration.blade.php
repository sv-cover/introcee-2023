                            ...
                            <form method="POST" action="{{ route('campregistration.firstyear') }}" id="first-year-form"
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="date" name="date_of_birth" placeholder="Ex: Date of Birth"
                                               required>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <input type="checkbox" name="terms_and_conditions" id="terms_and_conditions"
                                               required
                                               checked/>
                                        <label for="terms_and_conditions">I have read and greee to the&nbsp;<a
                                                href="https://filemanager.svcover.nl/uploads/introcee/terms-and-conditions-2023.pdf">terms
                                                and
                                                conditions</a>.</label>
                                    </div>
                    ...
                    @else
                        @if(1==1)
                            <div class="activities-section">
                                <div class="lower-box justify-content-center">
                                    <div class="sec-title light mt-0 ">
                                        <span class="sub-title">Unfortunately, the sign-ups for seniors have already ended!</span>
                                    </div>
                                </div>
                            </div>
                        @else
                            <form method="POST" action="{{ route('campregistration.senior') }}" id="senior-form"
                                ...
                                @if($coverApi->cover_session_logged_in())
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                            <label>Phone number</label>
                                            <input type="text" name="phone_number" placeholder="Ex: +3160000000"
                                                   required
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12 form-group">
                                            <label>Study Year (at the camp)</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <p class="remarks font-italic mb-3"><small>P.S. We are automatically filling
                                                    in
                                                    if
                                                    you
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <input type="checkbox" name="terms_and_conditions" id="terms_and_conditions"
                                                   required
                                                   checked/>
                                            <label for="terms_and_conditions">I have read and agree to the&nbsp;<a
                                                    href="https://filemanager.svcover.nl/uploads/introcee/terms-and-conditions-2023.pdf">terms
