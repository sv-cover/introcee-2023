            ...
            <div class="app-container container-xxl d-flex align-items-stretch justify-content-between"
                ...
                <div class="app-header-wrapper d-flex flex-grow-1 align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--end::Logo wrapper-->
                        <!--begin::Logo image-->
                        <a href="{{ route('home') }}" class="d-flex d-lg-none">
...
<script src="{{ asset('backoffice/js/custom/apps/chat/chat.js') }}"></script>
<script src="{{ asset('backoffice/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
<script src="{{ asset('backoffice/js/custom/utilities/modals/users-search.js') }}"></script>
