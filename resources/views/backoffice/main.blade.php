...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <h2 class="mb-5 mt-10">Introductory Barbecue</h2>
            <div class="row gy-5 g-xl-10">
                <!--begin::Col-->
                <div class="col-sm-6 col-xl-3">
                    <div class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">
                                {{ \App\Models\ParticipantBarbecue::where('confirmed', true)->where('first_year', true)->count() }}
                            </div>
                            <div class="fw-semibold text-gray-400">
                                Confirmed First-Years
                            </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">
                                {{ \App\Models\ParticipantBarbecue::where('first_year', true)->count() }}
                            </div>
                            <div class="fw-semibold text-gray-400">
                                First-year sign-ups
                            </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">
                                {{ \App\Models\ParticipantBarbecue::where('confirmed', true)->where('senior', true)->count() }}
                            </div>
                            <div class="fw-semibold text-gray-400">
                                Confirmed Seniors
                            </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">
                                {{ \App\Models\ParticipantBarbecue::where('senior', true)->count() }}
                            </div>
                            <div class="fw-semibold text-gray-400">
                                Senior sign-ups
                            </div>
...
$jsonData = json_encode($participantCounts);
    ...
    @php
            $participantsByDay = \App\Models\ParticipantBarbecue::select(DB::raw('DATE(created_at) as signup_date'), DB::raw('COUNT(*) as count'))
    ->groupBy('signup_date')
    ->get();
