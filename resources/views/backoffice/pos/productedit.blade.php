                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xl-2">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid mb-20">
                                    <input class="form-check-input" name="enabled" type="checkbox" value="on"
                            ...
                            <div class="col-xl-2">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-danger form-check-solid mb-20">
                                    <input class="form-check-input" name="restricted" type="checkbox" value="on"
                                           {{ $product->age_restriction ? 'checked' : '' }}
                                           id="flexSwitchDefault"/>
                                    <label class="form-check-label" for="flexSwitchDefault">
                                        Restricted
                                    </label>
                        ...
                        <style>
                            .image-input-placeholder {
                                background-image: url('data:image/jpg;base64,{{ base64_encode($product->image) }}');
                            }
                        ...
                        <label class="form-label mb-10">Product Image</label>
