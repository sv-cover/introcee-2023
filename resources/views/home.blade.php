            ...
            <div class="row clearfix">
                    ...
                    <div class="activities-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                        ...
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <p>Wednesday, September 6, 2023<br /> 21:00 @ Wolter Wolthers</p>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 inner-column">
                    <div class="content_block_two" style="height: calc(100% - 25px);">
                        <div class="content-box pt-5 pb-5" style="height: 100%;align-items: center;display: flex; justify-content: center;background-image:url({{ asset('images/camp-group-dark.jpg') }});background-size: cover;  background-position: center;">
                            <div class="upper">
